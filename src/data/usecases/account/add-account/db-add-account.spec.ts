...
const makeSut = (): SutTypes => {
  ...
  const loadAccountByEmailRepositoryStub: LoadAccountByEmailRepository = mockLoadAccountByEmailRepositoryStub()
...
describe('DbAddAccount', () => {
  ...
  test('Should throw if Hasher throws', async () => { 
    ...
    const promise: Promise<AccountModel|null> = sut.add(mockAccountData())
  ...
  test('Should return null if LoadAccountByEmailRepository not return null', async () => { 
    ...
    const account: AccountModel|null = await sut.add(mockAccountData())
  ...
  test('Should call LoadAccountByEmailRepository with correct email', async () => {
    ...
    const accountData: AddAccountParams = mockAccountData()
    await sut.add(accountData)
