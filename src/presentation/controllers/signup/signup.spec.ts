...
import { EmailValidator, Controller, HttpResponse, AccountModel, AddAccount, AddAccountModel } from './signup-protocols';
...
interface SutTypes {
  sut: Controller, emailValidatorStub: EmailValidator, addAccountStub: AddAccount
}
  ...
  test("Should return 400 if password confirmation fails", () => {
    ...
    const httpRequest = {
      body: {
        ...
        password: "any_pass", passwordConfirmation: "invalid_password"
      }
    }
    const httpResponse: HttpResponse = sut.handle(httpRequest);
    expect(httpResponse.statusCode).toBe(400);
